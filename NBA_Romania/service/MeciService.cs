...
class MeciService
{
    ...
    public string returneazaScorMeci(string ech1Name, string ech2Name, string strDate)
    {
        ...
        //2.get players from team1,team2
        ...
        //Console.WriteLine(jucatoriEchipa1.Count); ok
        //Console.WriteLine(jucatoriEchipa2.Count); ok
        
        //3.calculate total score for each team
        string gameId;
